...
HD_PWD='C:/Users/Nizamettin/Documents/GitHub/VIVADO_Z7020_PS_UART_PL_LED/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log physical_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source physical_bd_wrapper.tcl
