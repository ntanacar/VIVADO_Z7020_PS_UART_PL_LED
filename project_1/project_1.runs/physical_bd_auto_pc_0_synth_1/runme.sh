...
HD_PWD='C:/Users/Nizamettin/Documents/GitHub/VIVADO_Z7020_PS_UART_PL_LED/project_1/project_1.runs/physical_bd_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log physical_bd_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source physical_bd_auto_pc_0.tcl
