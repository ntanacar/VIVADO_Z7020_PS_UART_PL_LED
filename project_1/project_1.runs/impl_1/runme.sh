...
HD_PWD='C:/Users/Nizamettin/Documents/GitHub/VIVADO_Z7020_PS_UART_PL_LED/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log physical_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source physical_bd_wrapper.tcl -notrace
